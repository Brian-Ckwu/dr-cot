...
class DDXPredictorPrompt(Prompt):
    POSITIVE_CUE = "Based on the positive clinical findings: "
    NEGATIVE_CUE = "and the negative clinical findings: "
    DDX_CUE = "The ranked differential diagnosis can be listed as follows: "
...
class QuestionGeneratorPrompt(Prompt):
    ...
    NEGATIVE_CUE = "and the negative clinical findings: "
    DDX_CUE = "The ranked differential diagnosis can be listed as follows: "
    QUESTION_CUE = "To narrow down the differential diagnosis, the next question to ask the patient is:"
    ...
    def get_semantic_prompt(self, pos: list[str], neg: list[str], ddx: list[str]) -> str:
        ...
        return self.SHOT_SEPARATOR.join(chunks) + self.LINE_SEPARATOR + self.QUESTION_CUE
...
if __name__ == "__main__":
    ...
    qg_prompt_text = json.loads(Path("../prompts/doctor/multistage/question_generator_zero-shot.json").read_text())
